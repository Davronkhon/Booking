            ...
            <div class="nav-header">
                ...
                <nav id="fh5co-menu-wrap" role="navigation">
                    <ul class="sf-menu" id="fh5co-primary-menu">
                        <li><a class="#" href="{{ asset('home') }}">Главная</a></li>
                        <li>
                            <a href="{{ asset('hotel') }}" class="fh5co-sub-ddown">Рестораны</a>
                            <ul class="fh5co-sub-menu">
                                <li><a href="#">Отель люкс</a></li>
                                <li><a href="#">Отель делюкс</a></li>
                                <li>
                                    <a href="#" class="fh5co-sub-ddown">Королевский отель</a>
                                    <ul class="fh5co-sub-menu">
                                ...
                                <li><a href="#">Пяти звёздночный отель</a></li>
                            </ul>
                        </li>
